...
<head>
  <meta charset="UTF-8" />
  <title>Tambah Transaksi Dompet</title>
...
<body class="min-h-screen flex flex-col">
    ...
    <div class="navbar text-pink-900">
      <div class="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <nav class="nav-links hidden md:flex items-center space-x-6">
          ...
          <a href="tambah_transaksi.php" class="flex items-center space-x-1 text-pink-700 active">
            <span>💰</span>
            <span>Transaksi</span>
          </a>
    ...
    🚪 Logout
      ...
      <div id="mobileMenu" class="mobile-menu md:hidden bg-pink-50">
        <div class="container mx-auto px-6 py-3 flex flex-col space-y-4">
          ...
          <a href="tambah_transaksi.php" class="flex items-center space-x-2 text-pink-700 active py-2">
            <span>💰</span>
            <span>Transaksi</span>
          </a>
  ...
  <main class="container mx-auto px-6 py-8 flex-grow">
    <h2 class="text-3xl font-bold text-pink-800 mb-8 animate__animated animate__fadeIn">💰 Tambah Transaksi Dompet</h2>

    <div class="bg-white rounded-xl shadow-md p-6 animate__animated animate__fadeInUp">
      <form id="transaksiForm" class="space-y-6">
        <!-- Metode Pembayaran -->
        <div>
          <label for="metode" class="block text-sm font-medium text-pink-700 mb-2">Metode Pembayaran:</label>
        ...
        <!-- Jenis Transaksi -->
        <div>
          <label for="jenis" class="block text-sm font-medium text-pink-700 mb-2">Jenis Transaksi:</label>
        ...
        <!-- Jumlah -->
        <div>
          <label for="jumlah" class="block text-sm font-medium text-pink-700 mb-2">Jumlah (Rp):</label>
        ...
        <!-- Nama -->
        <div>
          <label for="keterangan" class="block text-sm font-medium text-pink-700 mb-2">Nama:</label>
        ...
        <!-- Keperluan -->
        <div>
          <label for="keperluan" class="block text-sm font-medium text-pink-700 mb-2">Keperluan:</label>
      ...
      <!-- Status Message -->
      <div id="formStatus" class="success-message mt-6 p-4 bg-pink-100 border-l-4 border-pink-500 text-pink-700 rounded-lg hidden animate__animated animate__fadeIn"></div>
    </div>
  </main>
