...
<body class="min-h-screen flex flex-col">
    ...
    <div class="navbar text-pink-900">
      <div class="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <nav class="nav-links hidden md:flex items-center space-x-6">
          ...
          <a href="tambah_saldo.php" class="flex items-center space-x-1 text-pink-700 active">
            <span>💳</span>
            <span>Saldo</span>
          </a>
    ...
    🚪 Logout
      ...
      <div id="mobileMenu" class="mobile-menu md:hidden bg-pink-50">
        <div class="container mx-auto px-6 py-3 flex flex-col space-y-4">
          ...
          <a href="tambah_saldo.php" class="flex items-center space-x-2 text-pink-700 active py-2">
            <span>💳</span>
            <span>Saldo</span>
          </a>
  ...
  <main class="container mx-auto px-6 py-8 flex-grow">
    <h2 class="text-3xl font-bold text-pink-800 mb-8 animate__animated animate__fadeIn">💳 Tambah / Set Saldo Manual</h2>

    <div class="bg-white rounded-xl shadow-md p-6 animate__animated animate__fadeInUp">
      <form id="saldoForm" class="space-y-6">
        <!-- Metode Dompet -->
        <div>
          <label for="saldo_metode" class="block text-sm font-medium text-pink-700 mb-2">Metode Dompet:</label>
          <select id="saldo_metode" required
        ...
        <!-- Jumlah -->
        <div>
          <label for="saldo_jumlah" class="block text-sm font-medium text-pink-700 mb-2">Jumlah (Rp):</label>
          <input type="number" id="saldo_jumlah" required
                 class="w-full px-4 py-2 border border-pink-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-pink-300" />
        </div>

        <!-- Aksi -->
        <div>
          <label class="block text-sm font-medium text-pink-700 mb-2">Aksi:</label>
          <div class="space-y-3">
            <label class="flex items-center space-x-3">
              <input type="radio" name="aksi" value="tambah" checked 
                     class="h-4 w-4 border-pink-300 text-pink-600 focus:ring-pink-500 radio-input" />
              <span>Tambah ke Saldo</span>
            </label>
            <label class="flex items-center space-x-3">
              <input type="radio" name="aksi" value="set" 
                     class="h-4 w-4 border-pink-300 text-pink-600 focus:ring-pink-500 radio-input" />
              <span>Set Ulang Saldo</span>
            </label>
          </div>
        </div>
      ...
      <!-- Status Message -->
      <div id="saldoStatus" class="success-message mt-6 p-4 bg-pink-100 border-l-4 border-pink-500 text-pink-700 rounded-lg hidden animate__animated animate__fadeIn"></div>
    </div>
  </main>
